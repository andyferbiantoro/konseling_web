  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">Tambah Data Larangan</h5>
      </div>
      <div class="modal-body">
       <form method="post" action="{{route('point_add')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <input type="hidden" class="form-control" id="perihal" name="perihal"  required="" value="Perihal Larangan Siswa"></input>
        </div>
...
<div id="updateInformasi" class="modal fade" role="dialog">
  <div class="modal-dialog">
   ...
   <form action="" id="updateInformasiform" method="post" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Anda yakin ingin memperbarui data larangan ini ?</h5>
